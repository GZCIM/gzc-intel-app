...
export const UserTabDebugger: React.FC = () => {
    ...
    const getUserStorage = () => {
        ...
        // Get current layout
        const currentLayoutStr = localStorage.getItem(
        ...
        if (currentLayoutStr) {
            try {
                ...
                data.tabs = layout.tabs.map((t: any) => ({
                    name: t.name,
                    type: t.type,
                }));
            } catch (e) {}
        ...
        // Get active tab
        data.activeTab = sessionStorage.getItem(
            `gzc-intel-active-tab-${userId}`
        );
